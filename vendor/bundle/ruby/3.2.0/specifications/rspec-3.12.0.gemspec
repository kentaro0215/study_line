...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.12.0".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.12.0".freeze])
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.12.0".freeze])
end
