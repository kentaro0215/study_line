# -*- encoding: utf-8 -*-
# stub: parser 3.3.0.4 ruby lib

Gem::Specification.new do |s|
  s.name = "parser".freeze
  s.version = "3.3.0.4".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/whitequark/parser/issues", "changelog_uri" => "https://github.com/whitequark/parser/blob/v3.3.0.4/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/parser/3.3.0.4", "source_code_uri" => "https://github.com/whitequark/parser/tree/v3.3.0.4" } if s.respond_to? :metadata=
