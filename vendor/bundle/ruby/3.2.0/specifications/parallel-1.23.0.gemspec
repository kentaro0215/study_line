...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/grosser/parallel/issues", "documentation_uri" => "https://github.com/grosser/parallel/blob/v1.23.0/Readme.md", "source_code_uri" => "https://github.com/grosser/parallel/tree/v1.23.0", "wiki_uri" => "https://github.com/grosser/parallel/wiki" } if s.respond_to? :metadata=
