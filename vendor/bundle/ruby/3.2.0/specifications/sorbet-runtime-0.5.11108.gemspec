# -*- encoding: utf-8 -*-
# stub: sorbet-runtime 0.5.11108 ruby lib

Gem::Specification.new do |s|
  s.name = "sorbet-runtime".freeze
  s.version = "0.5.11108".freeze
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.90.0".freeze])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.8.0".freeze])
  ...
  s.add_development_dependency(%q<parser>.freeze, ["~> 2.7.1".freeze])
